...
// TODO: Uncomment the following line of code to see the output in the browser console
 console.log('scopearrow', joe.scopeArrow());

// TODO: Write a COMMENT below to answer the following questions.
// 1. What is "this" when joe.scope() is invoked?
// This is seen as an object normally when it is invoked. It looks normal and 
// 2. What is "this" when joe.scopeArrow() is invoked?
// This is seen as an object that is the properties of the window and maybe the browser session? It shows the history, the local stoage, and all the stuff I had pulled up in other sitations
// 3. Explain why "this" is different when an arrow function is used.
// In the best terms I know, it was told to us that 'arrow functions afect scope'. In the readme it tells us straight out that instead of going to the object, due to the fact it doesnt recognize it, it will refer to the global window object, everything in your browser window and session.
